...
S3_INPUT = f"s3a://{BUCKET}/bronze/dimensao/fornecedores"

# workers e scheduler montam ./data em /opt/spark/work-dir/data
DATA_DIR  = "/opt/spark/work-dir/data/raw"
TMP_DIR   = f"{DATA_DIR}/_tmp_fornecedores"
DEST_FILE = f"{DATA_DIR}/fornecedores.parquet"

spark = (
    SparkSession.builder
    .appName("import_fornecedores")
